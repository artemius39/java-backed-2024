...
public class UserLink extends TableImpl<UserLinkRecord> {
    ...
    /**
     * The column <code>USER_LINK.USER_ID</code>.
     */
    public final TableField<UserLinkRecord, Long> USER_ID = createField(DSL.name("USER_ID"), SQLDataType.BIGINT.nullable(false), this, "");
    ...
    public List<ForeignKey<UserLinkRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CONSTRAINT_B, Keys.CONSTRAINT_BC);
    }
    ...
    public User user() {
        if (_user == null)
            _user = new User(this, Keys.CONSTRAINT_B);
    ...
    public Link link() {
        if (_link == null)
            _link = new Link(this, Keys.CONSTRAINT_BC);
