...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, OffsetDateTime> LAST_UPDATED = createField(DSL.name("LAST_UPDATED"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");
