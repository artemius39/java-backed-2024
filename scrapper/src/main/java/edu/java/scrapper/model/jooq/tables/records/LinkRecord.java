...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record3<Long, String, OffsetDateTime> {
     ...
     */
    public void setLastUpdated(@NotNull OffsetDateTime value) {
        set(2, value);
    }
     ...
     */
    @ConstructorProperties({ "id", "url", "lastUpdated" })
    public LinkRecord(@Nullable Long id, @NotNull String url, @NotNull OffsetDateTime lastUpdated) {
        super(Link.LINK);
     ...
     * Create a detached, initialised LinkRecord
     */
    public LinkRecord(edu.java.scrapper.model.jooq.tables.pojos.Link value) {
        super(Link.LINK);
